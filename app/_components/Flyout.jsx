...
const Logo = ({ color = "white" }) => {
  ...
  return (
    <Link className="flex items-center gap-1" href="/">
      <img
        src={`/logos/logo-${color}-new-notext.png`}
        alt="Logo"
...
const CTAs = () => {
  return (
    <div className="flex items-center gap-3">
      ...
      <button className="rounded-lg border-2 border-amber-300 bg-amber-300 px-4 py-2 font-semibold text-black transition-colors hover:border-amber-700 hover:bg-amber-700 hover:text-white">
        Book an Appointment
      </button>
    </div>
  );
